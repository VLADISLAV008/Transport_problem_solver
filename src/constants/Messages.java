...
public final class Messages {
    ...
    public static final String TITLE ="Solver of transport problems";
    public static final String FILE_NOT_UPLOADED = "The file not uploaded. Please load the file with transport problem.";
    ...
    public static final String INFO_PROGRAMME = "This program is capable of solving a general transport problem of an arbitrary type.\n" +
